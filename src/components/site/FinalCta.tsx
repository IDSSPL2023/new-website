...
export function FinalCta() {
  return (
    <section id="contact" className="relative overflow-hidden border-t border-hairline">
      ...
      <div className="shell relative py-20 md:py-26">
        <Reveal>
          <p className="eyebrow">Ready for the next generation of banking?</p>
        </Reveal>
        <Reveal delay={100}>
          <h2 className="display mt-7 max-w-[13ch] text-[clamp(2.4rem,7vw,6rem)] text-foreground">
            Build a smarter financial future.
          </h2>
        </Reveal>
        <Reveal delay={180}>
          <p className="mt-7 max-w-xl text-[15px] leading-relaxed text-muted-foreground">
            If your current systems are slowing you down or limiting your operations, it may be time
            to take a closer look at your technology foundation. Connect with our team to explore
            how IDSSPL can support your banking and financial systems with reliable, well-structured
            solutions.
          </p>
        </Reveal>
        <Reveal delay={240}>
